...
export default function StudentLogin({ onBack, onContinue }) {
  ...
  const handleSubmit = async (event) => {
    ...
    if (!isEmail(id) && !isValidStudentId(id)) {
      setError('Please enter a valid student ID or college email.')
      return
    }
    if (!password) {
  ...
  const handleForgotSubmit = async (event) => {
    ...
    if (!isValidStudentId(id) && !isEmail(forgotId)) {
      setForgotError('Please enter a valid student ID or college email.')
      return
    }
    setForgotError(null)
      ...
      {forgotMode ? (
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="e.g. 2K24IT001 or 2k24it001@kiot.ac.in"
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-5" noValidate>
          <div>
            ...
            <p className="mt-2 text-xs text-slate-400">
              Format: 2K24IT001 or your college email — ask your staff if you need help finding your ID.
            </p>
          </div>
